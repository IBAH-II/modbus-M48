///////////////////////////////////////////////////////////////////////////////
//             Асинхронная обработка сообщение ModBus v3iaravr               //
//             Автор - Iван                                                  //
///////////////////////////////////////////////////////////////////////////////
#ifndef __MODBUS_H
#define __MODBUS_H
...
//Настройки 
//Вычисление CRC
#define ModBusUseTableCRC (1) //Использовать вычисление СRС по таблице
//Обработка ошибок
...
#define ModBusMaxPauseResp (0) //Пауза между запросом Master и ответом Slave [mS]
//Длинна пакетов
...
#define ModBusMaxInBitTX (8) //Максимальное количество дискретных входов передаваемом пакете 
...
#define ModBusMaxInReg (4) //Количество входных регистров (регистры только для чтения)
...
#define ModBusMaxOutReg (16) //Количество выходных регистров
